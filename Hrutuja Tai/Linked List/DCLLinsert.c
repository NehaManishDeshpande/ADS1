...
node *posInsertDCll(int n, node* last){
    printf("\nEnter the Position after which data is to be entered in the DCLL:");
    scanf("%d", &n);
    int num;
